...
#define STRING_CONFIG_H_AUTHOR "Nick Traini" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "K280"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 610.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 160.0              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 760*1.1 }  // default steps per unit for PowerWasp
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 10000, 10000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -20.0, -28, 0.0 }
